...
export const TimeLineData = [
  { year: 2017, text: "Started my coding journey at college" },
...
export const data = [
  { number: 2, text: "Associates Degress" },
  { number: 60, text: "React Projects" },
  { number: 30, text: "Github Stars" },
  { number: 1, text: "Android Developer Certification" },
];
